...
export const catalog = [
	{
		...
		subcategories: [
			...
			},
			{
				...
				title: 'Панели',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/electrika3.jpg',
			},
			{
				id: '658aa910cd634ef7ce80f1c9',
				title: 'Пульты',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/electrika7.jpg',
			},
			{
			...
			},
			{
				...
				title: 'Щиты',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/electrika6.jpg',
			},
			{
				id: '658aa910cd634ef7ce80f1cc',
				title: 'Ящики управления',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/electrika4.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			{
				...
				title: 'Контакторы',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/031_big.jpg',
			},
			{
			...
			},
			{
				...
				title: 'Реле',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/repu12m.jpg',
				types: [
					{
						id: '658aac81cd634ef7ce80f1d4',
						title: 'Реле времени',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/41.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1d5',
						title: 'Реле контроля скорости',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/56.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1d6',
						title: 'Реле контроля фаз',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/57.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1d7',
						title: 'Реле напряжения',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/68.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1d8',
						title: 'Фотореле',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/102.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1d9',
						title: 'Реле промежуточные',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/90.jpg',
					},
					{
						id: '658aac81cd634ef7ce80f1da',
						title: 'Реле тока',
						image: 'http://prom-all.com/wp-content/uploads/2015/08/100.jpg',
					},
					{
			...
			},
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/28.jpg',
			},
			{
			...
			},
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/107.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/Motor2.jpg',
			},
			{
				id: '658aad8ecd634ef7ce80f1e3',
				title: 'Редукторы UNITdrive',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/seriyaDRV.jpg',
			},
			{
			...
			},
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/cherv.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/ventil.jpg',
			},
			{
			...
			},
			{
				...
				title: 'Клапаны',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/klapanu4.jpg',
			},
			{
				id: '658aaf54cd634ef7ce80f1eb',
				title: 'Конденсатоотводчики',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/klapanu3.jpg',
			},
			{
				id: '658aaf54cd634ef7ce80f1ec',
				title: 'Краны',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/kranu1.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			...
			},
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/nasos5.jpg',
			},
			{
				id: '658ab0abcd634ef7ce80f1f2',
				title: 'Насосы шестерёнчатые',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/nasos4.jpg',
			},
			{
				id: '658ab0abcd634ef7ce80f1f3',
				title: 'Насосы вихревые',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/nasos3.jpg',
			},
			{
		...
		subcategories: [
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/eldv8.jpg',
			},
			{
		...
		subcategories: [
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/image002.jpg',
			},
			{
				id: '6589b0067d4f83f1dfcaa232',
				title: 'Осевые вентиляторы',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/10057546.jpg',
			},
			{
				id: '6589b0067d4f83f1dfcaa233',
				title: 'Пылевые вентиляторы',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/image023.jpg',
			},
			{
				id: '6589b0067d4f83f1dfcaa234',
				title: 'Радиальные вентиляторы',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/image004.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			{
				...
				title: 'Тали ручные',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/tal4.jpg',
			},
			{
				id: '658ab25ccd634ef7ce80f201',
				title: 'Тали электрические',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/tal8.jpg',
			},
		],
	},
	{
		...
		subcategories: [
			...
			},
			{
				...
				image: 'http://prom-all.com/wp-content/uploads/2015/08/tormoz.jpg',
			},
			{
				id: '658ab3b3cd634ef7ce80f206',
				title: 'Электромагниты тормозные',
				image: 'http://prom-all.com/wp-content/uploads/2015/08/kran1.jpg',
			},
		],
	},
];
