...
import { FormSchema, IQuickOrderForm } from '../types';

/**
 * yup-схема формы быстрого заказа
 */
export const quickOrderFormSchema = yup.object().shape<FormSchema<IQuickOrderForm>>({
	name: yup
		.string()
